          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Text("Upper Mess",
                      style: TextStyle(color: Colors.white, fontSize: 30)),
                  flex: 3,
                ),
                Expanded(
                    child: Text(
                        curUpperMess.toString() + "/" + upperMessCap.toString(),
                        style: TextStyle(color: Colors.white, fontSize: 30)))
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Text("Lower Mess",
                      style: TextStyle(color: Colors.white, fontSize: 30)),
                  flex: 3,
                ),
                Expanded(
                    child: Text(
                        curLowermess.toString() + "/" + lowerMessCap.toString(),
                        style: TextStyle(color: Colors.white, fontSize: 30)))
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                    child: Text(
                        curNewMess.toString() + "/" + newMessCap.toString(),
                        style: TextStyle(color: Colors.white, fontSize: 30)))
              ],
            ),
          ),
